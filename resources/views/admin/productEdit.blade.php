...
<html lang="ja">
  <head>
    ...
    <link href="{{ asset('css/workEdit.css') }}" rel="stylesheet" type="text/css">
          ...
          <div class="body-container">
            ...
            <div class="eyecatch">
              ...
              <div class="eyecatch-wrap">
                <input type="file" name="eyecatch" accept="image/jpg,image/png" value="{{old('eyecatch',$product->eyecatch)}}">
                <p>アイキャッチ画像を変更</p>
                @if($product->eyecatch)
